...
/**
 * This is the model class for table "objectType".
 *
 * The followings are the available columns in table 'objectType':
 * @property integer $id
...
class ObjectType extends CActiveRecord
{
    ...
    const ALL_IN_ARRAY_CACHE = 'ObjectTypesInArrayCached';
	/**
