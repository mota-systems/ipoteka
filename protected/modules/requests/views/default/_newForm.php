...
//    'enableClientValidation'=>true,
    ...
    <script type='text/javascript'>
        ...
        function checker() {
            $('form[id = "request-form"]').find('div.row').each(function () {
    ...
    <!--    --><?//=CHtml::ajaxSubmitButton('Сделать запрос', array('checkFilters'), array('update' => '#result'), array('id'=>'sendRequest'))?>
    <?=CHtml::ajaxSubmitButton('Сделать запрос', array('checkFilters'), array('update' => '#result'), array('id' => 'sendRequest'))?>
    <? $this->widget('bootstrap.widgets.TdButton', array(
