...
<!--    --><?php echo $model->fullName;?>
    <?/* if ($model->organizationDecision AND Yii::app()->user->organizationType == Organizations::TYPE_AGENT) $this->widget('bootstrap.widgets.TbLabel', array(
    'type'  => $model->decisions->status_id == Requests::STATUS_APPROVE ? 'success' : 'important',
    'label' => $model->decisions->status_id == Requests::STATUS_APPROVE ? 'Одобрена' : 'Отклонена',
))*/?>
</h1>
